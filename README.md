...
| --------------------------------------------------------------------------------------------------- | --------------------------------------- | --------------------------------------------------------------------------- |
| 🧑🏻‍🦱 [Elect The Best](https://github.com/ELECT-THE-BEST/CR_ELECTION/tree/main)                               | A CR Election Platform using HTML, CSS, JS, JSP, MySQL, Python | [README](https://github.com/ELECT-THE-BEST/CR_ELECTION/blob/main/README.md)                |
